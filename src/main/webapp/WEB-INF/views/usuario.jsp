                    ...
                    <div class="info-content">
                        <table class="showDetailsTable">
                            ...
                            <tr>
                                ...
                                <td><p id="email-info-table"></p></td>
                                <td><p id="permissao-info-table"></p></td>
                            </tr>
                        </table>
                    </div>
                </div>
                        ...
                        <div class="input-wrapper">
                            ...
                            <div class="input-wrapper-inputs">
                                <div class="input-container">
                                    <input type="text" name="nome" id="nome" class="input-text" maxlength="50" required>
                                    <label for="nome" class="input-label"><span class="required">*&nbsp;</span>Nome</label>
                                </div>

                                <div class="input-container">
                                    <input type="text" name="email" id="email" class="input-text" maxlength="50" required>
                                    <label for="email" class="input-label"><span class="required">*&nbsp;</span>Email</label>
                                </div>

                                <div class="input-container">
                                    <input type="password" name="senha" id="senha" class="input-text" maxlength="64" required minlength="8">
                                    <label for="senha" class="input-label"><span class="required">*&nbsp;</span>Senha</label>
                                </div>

                                <div class="input-container">
                                    <select id="permissao" name="permissao" class="input-select static" required>
                                        <option value="ADMIN" selected>Administrador</option>
                                        <option value="USER" >Usuário</option>
                                    </select>
                                    <label for="permissao" class="input-label"><span class="required">*&nbsp;</span>permissao</label>
                                </div>
                            </div>
                        </div>
                    </div>
